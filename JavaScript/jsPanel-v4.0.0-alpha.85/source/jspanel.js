/* jspanel.js v4.0.0 (c) Stefan Sträßer(Flyer53) <https://github.com/Flyer53/jsPanel3> <info@jspanel.de> license: MIT */
/* global jsPanel, $ */
'use strict';
...
// CustomEvent polyfill for IE10 - https://developer.mozilla.org/en-US/docs/Web/API/CustomEvent/CustomEvent#Polyfill
(function () {
                ...
                handle.addEventListener(item, (e) => {
                    ...
                    dragElmt = (e) => {
                        ...
                        const pmx = e.touches ? e.touches[0].clientX : e.clientX,	// current pointer x while pointer moves (don't use pageY, doesn't work on FF for Android)
                            ...
                            leftVectorDrag   = Math.sqrt(elmtL2 + verticalDeltaDrag*verticalDeltaDrag),
                            topVectorDrag    = Math.sqrt(elmtT2 + horizontalDeltaDrag*horizontalDeltaDrag),
                            rightVectorDrag  = Math.sqrt(elmtR2 + verticalDeltaDrag*verticalDeltaDrag),
                            bottomVectorDrag = Math.sqrt(elmtB2 + horizontalDeltaDrag*horizontalDeltaDrag);
    ...
    create(options = {}, cb) {
        ...
        self.close = (callback) => {
            ...
            const doClose = () => {
                ...
                if (options.onclosed) {options.onclosed.call(panelId, panelId);}
            ...
            if (options.onbeforeclose && options.onbeforeclose.call(self, self) === false) {
                return self;
            }
        ...
        self.contentResize = (callback) => {
            const panelStyles = window.getComputedStyle(self),
                ...
                hdrHeight   = !options.headerRemove ? hdrStyles.height : 0,
        ...
        self.front = (callback) => {
            ...
            if (callback) {callback.call(self, self);}
            if (options.onfronted) {
                options.onfronted.call(self, self);
            }
            return self;
        };
        ...
        self.maximize = (callback) => {
            ...
            if (options.onbeforemaximize && options.onbeforemaximize.call(self, self) === false) {
                return self;
            }
            ...
            if (options.onstatuschange && options.onstatuschange.call(self, self) === false) {
                return self;
            }
            ...
            if (options.onmaximized) {
                options.onmaximized.call(self, self);
            }
        ...
        self.minimize = (callback) => {
            ...
            if (options.onbeforeminimize && options.onbeforeminimize.call(self, self) === false) {
                return self;
            }
            ...
            if (options.onminimized) {
                options.onminimized.call(self, self);
            }
        ...
        self.normalize = (callback) => {
            ...
            if (options.onbeforenormalize && options.onbeforenormalize.call(self, self) === false) {
                return self;
            }
            ...
            if (options.onnormalized) {
                options.onnormalized.call(self, self);
            }
        ...
        self.smallify = (callback) => {
            ...
            if (options.onbeforesmallify && options.onbeforesmallify.call(self, self) === false) {
                return self;
            }
            ...
            if (options.onsmallified) {
                options.onsmallified.call(self, self);
            }
        ...
        self.unsmallify = (callback) => {
            if (self.status === 'smallified' || self.status === 'smallifiedmax') {
                if (options.onbeforeunsmallify && options.onbeforeunsmallify.call(self, self) === false) {
                    return self;
                }
                ...
                if (options.onunsmallified) {
                    options.onunsmallified.call(self, self);
                }
            }
        ...
        if (!options.headerRemove) {
            if (options.headerLogo) {self.setHeaderLogo(opts.headerLogo);}
        ...
        // option.callback
        if (options.callback && Array.isArray(options.callback)) {
